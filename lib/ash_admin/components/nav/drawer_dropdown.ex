    ...
    <div class="relative">
      <div x-data="{isOpen: false}">
        <a
          ...
          class="mt-1 block px-3 py-2 rounded-t text-base font-medium text-gray-300 hover:text-white hover:bg-gray-700 focus:outline-none focus:text-white focus:bg-gray-700" href="#"
